...
def parse_data_generator_args(argv):
    ...
    # https://buganizer.corp.google.com/issues/121202294 
    # Limit the number of workers initiated by the application to a defined default

    parser.add_argument('--num_worker', type=int, default=DEFAULT_NUM_WORKERS, help='Number of workers to use.')
    parser.add_argument('--max_num_workers', type=int, default=DEFAULT_MAX_NUM_WORKERS, help='Set the maximum number of workers allowed')
